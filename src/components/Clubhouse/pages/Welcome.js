    ...
    return (
        <div className="WelcomeContainer">
            ...
            <div className='actionButton'>
                <Link to='/clubhouse/getUsername' className='kd-action-button d-flex align-items-center mb-3'>Get your username</Link>
                <Link to='/clubhouse/friendsinvite'>Have an invite text? Sign in</Link>
