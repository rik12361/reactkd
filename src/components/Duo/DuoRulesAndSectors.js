...
function DuoRulesAndSectors() {
  return <div>
  <OuterContainer className='kd-duo-container'>
   <InnerContainer>
       
       <hr></hr>
       <h1>Informatie over regelingen voor elke onderwijssector</h1>
       <CardsContainer>
       {duoNews.CardsCategory.filter(cat => cat.CardCategory === "Sectors").map((news) => (
...
export default DuoRulesAndSectors;
